...
class FiscalResultDialog extends ConsumerStatefulWidget {
  ...
  /// Chek "xato" deb belgilanganda — XATO CHEK bannerli nusxani chop etish
  /// va keyingi (to'g'ri) chekda havola qoldirish uchun.
...
class _FiscalResultDialogState extends ConsumerState<FiscalResultDialog> {
  ...
  Future<void> _markError() async {
    ...
    // keyingi to'g'ri chekda shu raqamga havola qoldiramiz.
