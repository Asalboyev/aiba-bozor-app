...
/// boshlash/yopish, o'ngda Top mahsulotlar. Qorong'i panel, suv fonida.
...
class _ShiftScreenState extends ConsumerState<ShiftScreen> {
  ...
  /// «закрытие дня» summasi bilan solishtiriladi.
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, bc) {
      // Kichik kassa ekrani (monoblok ~1024px): «Top mahsulotlar» paneli
  ...
  Widget _dashboard(BuildContext context, WidgetRef ref, Shift? shift,
    ...
    // Plitkalar: keng ekranda bitta qatorda, kichik kassa ekranida (tor)
    ...
    return LayoutBuilder(builder: (context, dc) {
      ...
      children: [
        ...
        const SizedBox(height: 14),
        // 5) Markazlashgan ko'rsatkichlar (Figma) — torda 3+2 bo'lib.
