...
class ReceiptBuilder {
  ...
  static Future<List<int>> buildZReport({
    ...
    if (errorChecks > 0) {
      // Soni + summasi: rahbar «qancha pul xatoga urilgan»ni chekda ko'radi.
      bytes.addAll(_tx(g,
    ...
    // olgan» summasini Z-chekda ham ko'radi (masalan 5 ta x 100 000 = 500 000).
