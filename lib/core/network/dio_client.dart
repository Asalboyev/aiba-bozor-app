...
/// Yangilanmagan/aktivlashtirilmagan Windows kassalarda tizim ishonch
...
class DioClient {
  DioClient(this._config, {this.onUnauthorized}) : _dio = Dio() {
    _dio.options
      // Bozor ilovasi FAQAT onlayn — server yo'q bo'lsa 10 soniya kutib
      // turmasin, 5 soniyada aniq xabar chiqsin.
