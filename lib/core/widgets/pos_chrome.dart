...
class _NavItemState extends State<_NavItem> {
  ...
  Widget build(BuildContext context) {
    ...
    // Rang: tanlangan — oq; hover — ochroq; oddiy — muted.
    final color = selected
        ? Colors.white
        : (_hover ? const Color(0xFFCBD0D5) : PosColors.muted);
    // Chip foni: tanlangan to'laroq, hover mayin, aks holda shaffof.
...
class PosAvatar extends StatelessWidget {
  ...
  /// Kichik ekranda (chap menyu ichida) — strelka ko'rsatilmaydi, avatarning
  /// O'ZI bosiladi. Katta ekranda (o'ng yuqorida) Figma ko'rinishi: K + strelka.
  final bool compact;
